...
class MockStorageDriver {
  constructor(options) {
    ...
    this.costPerByte = toBigNumber((options === null || options === void 0 ? void 0 : options.costPerByte) != null ? options === null || options === void 0 ? void 0 : options.costPerByte : DEFAULT_COST_PER_BYTE);
  }
